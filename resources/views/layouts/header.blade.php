...
<form id="searchthis" action="/search" style="float: left;" method="get">
	@csrf
	<input id="namanyay-search-box" name="search_text" type="text" placeholder='{{ __('Search for a friend') }}'/>
...
<span>
	<a href="/home"><i class="fa fa-home fa-lg" style="color:blue" aria-hidden="true" title="{{ __('Home') }}"></i>
</span></a>&nbsp &nbsp
...
<span class="col-sm-offset-3">
  @if(Auth::check())
    @if($impersonateStart ?? '')
      <a href="/stopImpersonate"><b>Stop Impersonate</b></a>
    @else
      <div class="btn-group">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="/profile"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp My Profile</a>
          <a class="dropdown-item" href="/setting"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp Profile Settings</a>
          <a class="dropdown-item" href="/photos"><i class="fa fa-picture-o" aria-hidden="true"></i>&nbsp My Gallery</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="/logout" style="color: red"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp {{ __('Logout') }}</a>
        </div>
      </div>
    @endif
  @endif
